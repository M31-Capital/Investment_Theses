...
**Demand for Terra applications = Demand for LUNA**
* To use Terra applications, users would have to get Terra native stablecoins which are backed by LUNA. 
* For example, if users want to trade on Mirror protocol (Terra’s derivative exchange Dapp), they will have to use UST to buy the synthetic assets.
* UST is generated by burning LUNA, and can be redeemed for 1 USD worth of LUNA, creating a value-backed stablecoin. 
* The more UST users need, the more LUNA burnt, which will help appreciate LUNA’s price. 


## Catalysts: 

* Orion Money gateway for other stablecoins i.e. USDT, USDC and DAI to be converted to UST and used in Anchor protocol. 
* Only 20% of the current circulating supply is unstaked. Could lead to a supply shortage if a large amount of UST is demanded. 
* Upcoming airdrops that incentivise people to buy and stake LUNA.
* TerraKado integration with e-commerce platforms like Amazon.
...
* No real competitors aside from Neobanks? 

**Crypto Competitors (none is really similar to Terra):** 
...
* Uncertainty around China-based CEXes 
* Arbitrum scaling solution to be released on 28th May – Should increase volumes traded on Sushiswap. 
...
1.	No Etherscan and Dune Analytics equivalent. 
...
1.	Terra has only launched Mirror protocol in late 2020 and Anchor in Q1 2021, setting the foundation to become a mainstream financial application. The creation of other protocols like Orion and Ozone will increase Terra’s value proposition and demand for LUNA. 
2.	Stablecoins are a large market, and the current version of algorithmic stablecoins are not great. DAI has become centralised while others struggle to keep their peg. UST could become the de-facto decentralised stablecoin.   
